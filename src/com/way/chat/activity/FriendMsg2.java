...
public class FriendMsg2 extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.friend_msg2);
...
//		submitCheck(user.getId());
		BtnChat.setOnClickListener(new Button.OnClickListener()
		{
			...
			{
				Intent intent = new Intent(FriendMsg2.this, ChatActivity.class);
		...
		BtnDelete.setOnClickListener(new Button.OnClickListener()
		{
			...
			public void onClick(View v)
			{
                ...
                intent.setClass(FriendMsg2.this, FriendListActivity.class);   
                startActivity(intent);
			}
